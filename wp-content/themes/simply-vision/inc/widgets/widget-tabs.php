...
/**
 * Adds Modern_Wp_Themes_Tabs widget.
 */
add_action( 'widgets_init', create_function( '', 'register_widget( "modernwpthemes_tabs" );' ) );
class modernwpthemes_Tabs extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'MWP Tabs',
			array(
				'description'	=> __( 'Display a tabbed content widget for your popular posts, recent posts and popular tags.', 'modernwpthemes' )
			)
		);
	}
	 ...
	 private function widget_fields() {
		$fields = array(
			...
			'tabs_post_count' => array (
				'modernwpthemes_widgets_name'				=> 'tabs_post_count',
				'modernwpthemes_widgets_title'			=> __( 'Posts to Show', 'modernwpthemes' ),
				'modernwpthemes_widgets_field_type'		=> 'text'
			),
			'tabs_tag_count' => array (
				'modernwpthemes_widgets_name'				=> 'tabs_tag_count',
				'modernwpthemes_widgets_title'			=> __( 'Tags to Show', 'modernwpthemes' ),
				'modernwpthemes_widgets_field_type'		=> 'text'
			),
		);
	...
	public function widget( $args, $instance ) {
		...
		<ul id="widget-tab" class="clearfix widget-tab-nav">
			<li class="active"><a href="#widget-tab-popular"><?php _e( 'Popular', 'modernwpthemes' ); ?></a></li>
			<li><a href="#widget-tab-latest"><?php _e('Latest', 'modernwpthemes' ); ?></a></li>
			<li><a href="#widget-tab-tags"><?php _e( 'Tags', 'modernwpthemes' ); ?></a></li>
		</ul>
				...
				<?php $popular = new WP_Query('orderby=comment_count&ignore_sticky_posts=1&posts_per_page=' . $tabs_post_count );
					...
					<li class="clearfix">
						...
						<div class="widget-entry-summary">
							...
							<span><?php comments_number( __( 'No Comments', 'modernwpthemes' ), __( '1 Comment', 'modernwpthemes' ), __( '% Comments', 'modernwpthemes' ) ); ?></span>
						</div>
						<?php } else { ?>
