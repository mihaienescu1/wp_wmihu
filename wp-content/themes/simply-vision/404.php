		...
		<div id="content" class="site-content" role="main">
			...
			<section class="error-404 not-found">
				...
				<div class="page-content">
					...
					<?php if ( modernwpthemes_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>
					<div class="widget widget_categories">
						<h3 class="widget-title"><span><?php _e( 'Most Used Categories', 'modernwpthemes' ); ?></span></h3>
						<ul>
						<?php
					...
					$archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', 'modernwpthemes' ), convert_smilies( ':)' ) ) . '</p>';
