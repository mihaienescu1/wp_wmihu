...
(function($){
	$.fn.mapmarker = function(options){
		...
		return this.each(function() {
			...
			// addMapMarker(map_element, opts.zoom, opts.center, opts.mapType, opts.controls, opts.scrollwheel, opts.draggable, opts.doubleclickzoom, opts.markers, opts.styling, opts.featureType, opts.visibility, opts.elementType, opts.color, opts.hue, opts.saturation, opts.lightness, opts.gamma);
	...
	// function addMapMarker(map_element, zoom, center, mapType, controls, scrollwheel, draggable, doubleclickzoom, controls, markers, styling, featureType, visibility, elementType, color, hue, saturation, lightness, gamma){
	function addMapMarker(map_element, opts){
		...
		if(opts.styling) {
			var myMapStyles = [
				{ featureType: opts.featureType, elementType: opts.elementType, stylers: [ { visibility: opts.visibility } , { color: opts.color } , { hue: opts.hue }, { saturation: opts.saturation },{ lightness: opts.lightness }, { gamma: opts.gamma } ] }
			];
