...
jQuery(document).ready(function($) {
    ...
    $('.social_wrap').tooltip({ selector: "a[data-toggle=tooltip]"});
    $('.wt_tooltips').tooltip({ selector: "a[data-toggle=tooltip]"});
    $('#headerWrapper .social_wrap a[data-toggle=tooltip], #topWidgetWrapper .social_wrap a[data-toggle=tooltip]').tooltip({placement: 'bottom', animation: true});
