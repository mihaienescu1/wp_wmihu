...
class wt_admin {
	...
	function wt_warnings(){
		...
		if(!wt_check_wp_version()){
			$warnings[]='Wordpress version(<b>'.$wp_version.'</b>) is too low. Please upgrade to 3.1';
		}
	...
	function wt_menus(){
		...
		//add_submenu_page('general', 'Intro Header', 'Intro Header', 'edit_theme_options', 'intro_header', array(&$this,'_load_option_page'));
		...
		add_submenu_page('general', 'Slideshow', 'Slideshow', 'edit_theme_options', 'slideshow', array(&$this,'_load_option_page'));
		add_submenu_page('general', 'Media', 'Media', 'edit_theme_options', 'media', array(&$this,'_load_option_page'));
