...
$options = array(
	...
	array(
		"name" => __("Page Alignment",'wt_admin'),
		"desc" => __("Specify the alignment of the this portfolio item.", 'wt_admin'),
		"id" => "_site_alignment",
		"prompt" => __("Choose alignment",'wt_admin'),
		"default" => '',
		"options" => array(
	...
	array(
		"name" => __("Client",'wt_admin'),
		"desc" => __('In this field add your client name.','wt_admin'),
		"id" => "_client",
		"default" => "",
		"type" => "wt_text"
	),
	array(
		"name" => __("Website",'wt_admin'),
		"desc" => __('In this field add your client website.','wt_admin'),
		"id" => "_website",
		"default" => "",
		"type" => "wt_text"
	),
	...
	array(
		"name" => __("Enable Read More",'wt_admin'),
		"desc" => __("Set the button to ON if you want the read more link to be displayed.",'wt_admin'),
		"id" => "_more",
		"default" => "",
		"type" => "wt_tritoggle"
	),
	/*array(
		"name" => __("Link for Read More",'wt_admin'),
		"id" => "_more_link",
		"default" => "",
		"shows" => array('page','cat','post','manually'),
		"type" => "wt_superlink"
	...
	array(
		"name" => __("Link Target for Read More",'wt_admin'),
