...
function wt_admin_register_script(){
	...
	wp_enqueue_script('theme-shortcode',THEME_ADMIN_ASSETS_URI . '/js/shortcode.js',array('jquery'));
...
function wt_admin_add_style() {
	...
	wp_enqueue_style('theme-style-gallery', THEME_ADMIN_ASSETS_URI.'/css/gallery.css', false, false, 'all');
