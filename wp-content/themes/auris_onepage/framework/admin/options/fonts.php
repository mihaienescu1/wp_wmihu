...
$wt_options = array(
	...
	array(
		...
		array(
			...
			"id" => "font_family",
			"default" => '"Lucida Sans Unicode","Lucida Grande","Droid Sans",sans-serif;',
			"options" => array(
				'HelveticaNeue,"Helvetica Neue",Arial,Helvetica,sans-serif' => 'HelveticaNeue,"Helvetica Neue",Arial,Helvetica,sans-serif',
		...
		array(
			"name" => __("Line Height",'wt_admin'),
			"desc" => "Choose the line height for site text.",
			"id" => "line_height",
			"min" => "1",
			"max" => "3",
			"step" => "0.05",
	...
	array(
		...
		array(
			...
			array(
				...
				"id" => "used_googlefonts",
				"default" => array('Raleway:300,400,700','PT Sans','Open Sans:regular,regularitalic'),
			...
			array(
				...
				"id" => "gfonts_code",
				"default" => 'h1, h2, h3, h4, h5, #wt_intro p, #logo, .custom_links span, .pp_description, #nav a.level-1-a {
	font-family: \'Raleway\';
}
	...
	array(
		...
		array(
			...
			array(
				...
				"id" => "fontface_code",
				"default" => "body, .affix #nav li a.level-1-a, h3.widgettitle, .portofolio_details h4, #flexSlider .flex-caption h2, #nivoSlider .nivo-caption h2, #cycle_slider .cycle-overlay h2 { font-family: OpenSansRegular; }
h1.slogan, .button_red, h1, h2, h3, h4, h5, h6, .team_description h3, #wt_sidebar h3, .entry_date, .blogEntry_content .read_more_link, .skill, .progress_bar_title, #wt_footer .widget ul li a, #wt_footer .recentTweets li a {font-family: 'OpenSansSemibold' }
#introType h1, .services_item h2 {font-family: 'OpenSansBold' }
span.quotes_text {font-family: 'OpenSansSemiboldItalic' }
...
h1.title, h2.title, span.quotes_author, .contact_button {font-family: 'OpenSansSemibold' }
h3.custom_title, input, textarea, #flexSlider .flex-caption h3, #flexSlider .flex-caption .wt_button.button_slide, #nivoSlider .nivo-caption h3 ,#nivoSlider .nivo-caption .wt_button.button_slide, #cycle_slider .cycle-overlay h3, #cycle_slider .cycle-overlay .wt_button.button_slide, #copyright p { font-family: OpenSansLight; }",
				"rows" => '8',
				"type" => "wt_textarea"
			),
		array(
		...
		array(
			...
			array(
				...
				"default" => array('Opensans|OpenSansRegular', 'Opensans|OpenSansSemibold', 'Opensans|OpenSansBold', 'Opensans|OpenSansItalic', 'Opensans|OpenSansLight', 'Opensans|OpenSansSemiboldItalic'),
				"type" => "wt_custom"
			),
		array(
			"type" => "wt_close"
