...
if (! function_exists("wt_blog_page_process")) {
	function wt_blog_page_process($option,$value) {
...
$wt_options = array(
	...
	/*array(
		...
		array(
			...
			array(
				"name" => __("Blog Page",'wt_admin'),
				"desc" => __("The blog is displayed on the page you'll choose here.",'wt_admin'),
				"id" => "blog_page",
				"page" => 0,
				"default" => 0,
	...
	array(
		...
		array(
			...
			/*array(
				"name" => __("Show in Header Area",'wt_admin'),
				"desc" => __("if the button is set to ON then the blog title and blog meta informations will be displayed in the page description area.",'wt_admin'),
				"id" => "show_in_header",
				"default" => true,
				"type" => "wt_toggle"
			),*/
			...
			array(
				"name" => __("Related & Popular Post Module",'wt_admin'),
				"desc" => "If the button is set to ON then the Related & Popular Post Module will be displayed in the Blog Single Post page.",
				"id" => "related_popular",
				"default" => true,
				"type" => "wt_toggle"
			),
	...
	array(
		...
		array(
			...
			array(
				...
				"desc" => __("You can set the Featured Image Entry height for full width layouts. ( Adaptive height option above should be OFF ).  Default height is 350px.",'wt_admin'),
				"id" => "image_height",
				"min" => "1",
				"max" => "640",
				"step" => "1",
		...
		array(
			"name" => __("Left Float Featured Post Entry",'wt_admin'),
			"type" => "wt_open"
		),
			array(
				"name" => __("<em>\"Full Layout\"</em> - Width",'wt_admin'),
				"desc" => __("You can set the width of the left floated image entry for full layouts. Even if you set a small width, the featured images uploaded should't have less than 400px width, otherwise they will look distorted on smaller screens. Default width is 460px.",'wt_admin'),
				"id" => "left_width",
				"min" => "1",
				"max" => "460",
				"step" => "1",
			...
			array(
				"name" => __("<em>\"Full Layout\"</em> - Featured Image Height",'wt_admin'),
				"desc" => __("You can set the height of the left floated image entry for full layouts. Default height is 220px.",'wt_admin'),
			...
			array(
				"name" => __("<em>\"Full Layout\"</em> - Featured Slide Height",'wt_admin'),
				"desc" => __("You can set the height of the left floated slide entry for full layouts. Default height is 220px.",'wt_admin'),
			...
			array(
				"name" => __("<em>\"Sidebar Layout\"</em> - Width",'wt_admin'),
				"desc" => __("You can set the width of the left floated image entry for layouts with sidebar. Even if you set a small width, the featured images uploaded should't have less than 400px width, otherwise they will look distorted on smaller screens. Default width is 210px.",'wt_admin'),
			...
			array(
				"name" => __("<em>\"Sidebar Layout\"</em> - Featured Image Height",'wt_admin'),
				"desc" => __("You can set the height of the left floated image entry for layouts with sidebar. Default height is 250px.",'wt_admin'),
			...
			array(
				"name" => __("<em>\"Sidebar Layout\"</em> - Featured Slide Height",'wt_admin'),
				"desc" => __("You can set the height of the left floated slide entry for layouts with sidebar. Default height is 250px.",'wt_admin'),
