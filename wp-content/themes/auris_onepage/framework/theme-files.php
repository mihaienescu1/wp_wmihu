...
class wt_themeFiles {
	...
	function wt_shortcodes() {
		...
		require_once (THEME_SHORTCODES . '/sections.php');
		require_once (THEME_SHORTCODES . '/columns.php');
		require_once (THEME_SHORTCODES . '/tooltip.php');
		require_once (THEME_SHORTCODES . '/dividers.php');
		require_once (THEME_SHORTCODES . '/margins.php');
		require_once (THEME_SHORTCODES . '/tag.php');
		require_once (THEME_SHORTCODES . '/lightbox.php');
		require_once (THEME_SHORTCODES . '/slideshow.php');
		require_once (THEME_SHORTCODES . '/rotator.php');
		...
		require_once (THEME_SHORTCODES . '/isotope_element.php');
