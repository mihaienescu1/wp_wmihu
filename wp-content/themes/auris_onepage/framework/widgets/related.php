 ...
 * @since 2.8.0
 */
class Wt_Widget_Related_Posts extends WP_Widget {

	function Wt_Widget_Related_Posts() {
		$widget_ops = array('classname' => 'widget_related_posts', 'description' => __( "The most related posts on your site", 'wt_admin') );
		$this->WP_Widget('related_posts', THEME_SLUG.' - '.__('Related Posts', 'wt_admin'), $widget_ops);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Related Posts', 'wt_front') : $instance['title'], $instance, $this->id_base);
