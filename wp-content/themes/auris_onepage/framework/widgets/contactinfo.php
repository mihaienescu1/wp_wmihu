...
class Wt_Widget_Contact_Info extends WP_Widget {
	...
	function Wt_Widget_Contact_Info() {
		...
		$this->WP_Widget('contact_info',THEME_SLUG.' - '. __('Contact Info', 'wt_admin'), $widget_ops);
	...
	function widget( $args, $instance ) {		
        ...
        <div class="wt_contactInfo">
			...
			<?php if(!empty($name)):?><p class="wt_contactName"><i class="wt_icon-user"></i><?php echo $name;?></p><?php endif;?>
            <?php if(!empty($address)):?><p class="wt_contactAddress"><i class="wt_icon-map-marker"></i><?php echo $address;?><?php endif;?>
			<?php if(!empty($city)||!empty($zip)):?>
           		<?php if(empty($address)):?><p class="wt_contactAddress"><i class="wt_icon-map-marker"></i><?php endif;?>
			...
			<?php if(!empty($phone)):?><p class="wt_contactPhone"><i class="wt_icon-phone"></i><?php echo $phone;?></p><?php endif;?>
			<?php if(!empty($cellphone)):?><p class="wt_contactCellPhone"><i class="wt_icon-phone-sign"></i><?php echo $cellphone;?></p><?php endif;?>
			<?php if(!empty($email)):?><p class="wt_contactMail"><i class="wt_icon-envelope"></i><a href="mailto:<?php echo $email;?>" class="nospam"><?php echo $email;?></a></p><?php endif;?>
			<?php if(!empty($link)):?><p class="wt_contactLink"><i class="wt_icon-link"></i><a href="<?php echo $link;?>" target="_blank"><?php echo $link;?></a></p><?php endif;?>
			<?php if(!empty($twitter)):?><p class="wt_contactTwitter"><i class="wt_icon-twitter"></i><a href="<?php echo $twitter;?>" target="_blank"><?php echo $twitter;?></a></p><?php endif;?>
