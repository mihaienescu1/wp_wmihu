...
class Wt_Widget_Popular_Posts extends WP_Widget {
	...
	function Wt_Widget_Popular_Posts() {
		$widget_ops = array('classname' => 'widget_popular_posts', 'description' => __( "The most popular posts on your site", 'wt_admin') );
		$this->WP_Widget('popular_posts', THEME_SLUG.' - '.__('Popular Posts', 'wt_admin'), $widget_ops);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Popular Posts', 'wt_front') : $instance['title'], $instance, $this->id_base);
