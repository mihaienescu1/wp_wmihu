...
$settings_icons = array(
    'newsflash_general_settings' => 'icon-cogs',
    'newsflash_menu_settings' => 'icon-cog',  //will available from next update
    'newsflash_typo_settings' => 'icon-font',  //will available from next update
    'newsflash_custom_css' => 'icon-cog',
