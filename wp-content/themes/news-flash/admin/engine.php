...
function newsflash_custom_css(){
    ...
    $fonts = get_option('newsflash_typo_settings',array());
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <ul class="nav nav-tabs smn">
                            ...
                            <li class="<?php echo $section_id; ?> <?php echo $section==$section_id?'active':''; ?>"><a href="#<?php echo $section_id; ?>" id="tab_<?php echo ++$tbc;?>" data-toggle='tab'><i class="icon-section icon <?php echo $settings_icons[$section_id]?$settings_icons[$section_id]:'icon-cog' ?>"></i> <?php echo $section_name; ?></a></li>
                            <?php } ?>
